...
export class FormAddTeach extends React.Component{
            ...
            <div className="formAddUser">
               ...
               <div className="form-item morespace">
                ...
                <div className="btnBox smallbtn morespace">
                    <button className="registerBack nomargin" onClick={this.addNewTeach}>Registrar</button>
